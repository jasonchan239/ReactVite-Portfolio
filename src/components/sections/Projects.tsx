...
const projects = [
  {
    ...
    description: "A simple Single-page web page to display my portfolio and projects. Built with React, Vite, and styled with Emotion.",
    image: "https://via.placeholder.com/400x200",
    techStack: ["React", "TypeScript", "Vite", "Emotion"],
    githubUrl: "https://github.com",
    liveUrl: "",
  },
  {
    id: 2,
    title: "Unreal Engine 5 Game - Covert Recovery",
    description: "A simple game demo made in Unreal Engine 5. The game is a stealth first-person shooter. Built with C++ and Unreal Engine 5.",
    image: "https://via.placeholder.com/400x200",
    techStack: ["Unreal Engine 5", "C++"],
    githubUrl: "https://github.com/jasonchan239/CovertRecovery-Game",
    liveUrl: "",
  },
  // {
  //   id: 3,
